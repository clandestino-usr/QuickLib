...
A lightweight, read-only web browser for [Calibre](https://calibre-ebook.com/) libraries. Built with Node.js, Express 5, and the built-in `node:sqlite` module — no external database driver needed.
